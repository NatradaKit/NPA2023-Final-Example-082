...
# 4. Provide the URL to the Webex Teams messages API, and extract location from the received message.
    ...
    if message.find("/Natrada") == 0:
    # แยกข้อความหลัง "/Natrada" และเอาช่องว่างที่เหลือออก
        location = message[len("/Natrada "):].strip()
        print(location)  # แสดงผลชื่อเมืองที่ถูกแยกออกมา
...
# 5. Prepare openweather Geocoding APIGetParameters..
        ...
        openweatherGeoAPIGetParameters = {
            "q": location,
            "limit": 1,
            "appid": "20ee1cb27c6f55253c8158f75196afed",
        }
